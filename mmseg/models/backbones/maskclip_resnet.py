...
class BottleneckMaskclip(Bottleneck):
    """Bottleneck block from MaskClip(ECCV2022).

    This is same with the style is 'clip' on the resnet.py in MaskClip code.
    """
    ...
    def __init__(self,
                 ...
                 plugins=None,
                 init_cfg=None):
        super(BottleneckMaskclip, self).__init__(
                inplanes=inplanes,
                 planes=planes,
                 stride=stride,
                 dilation=dilation,
